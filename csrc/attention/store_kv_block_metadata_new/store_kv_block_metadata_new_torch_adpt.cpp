 ...
 */
#ifndef STORE_KV_BLOCK_METADATA_NEW_TORCH_ADPT_H
#define STORE_KV_BLOCK_METADATA_NEW_TORCH_ADPT_H
    ...
    int64_t block_size)
{
    ...
    EXEC_NPU_CMD(aclnnStoreKvBlockMetadataNew,
                 slot_mapping_npu,
                 group_len,
                 group_key_idx,
                 group_key_cache_idx,
...
#endif  // STORE_KV_BLOCK_METADATA_NEW_TORCH_ADPT_H
