...
/*!
 * \file aclnn_store_kv_block_metadata_new.cpp
 * \brief AClnn interface for StoreKvBlockMetadataNew operator
 */

#include "aclnn_store_kv_block_metadata_new.h"
#include "l0_store_kv_block_metadata_new.h"
...
aclnnStatus aclnnStoreKvBlockMetadataNewGetWorkspaceSize(
...
{
    L2_DFX_PHASE_1(aclnnStoreKvBlockMetadataNew,
    ...
    auto ret = l0op::StoreKvBlockMetadataNew(slotMappingContiguous,  groupLen, groupKeyIdx, groupKeyCacheIdx,blockSize,
                                          uniqueExecutor.get());
...
__attribute__((visibility("default"))) aclnnStatus aclnnStoreKvBlockMetadataNew(void *workspace, uint64_t workspaceSize,
                                                                             aclOpExecutor *executor, aclrtStream stream)
{
    L2_DFX_PHASE_2(aclnnStoreKvBlockMetadataNew);
